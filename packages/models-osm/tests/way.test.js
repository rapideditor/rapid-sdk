...
//         iD.osmNode({ id: 'a', loc: [0.0003, 0.0] }),
...
//       expect(iD.osmWay({ tags: { oneway: 'reversible' } }).isOneWay(), 'oneway reversible').to.be
//         .true;
//     });

//     it('returns true when the way has tag oneway=alternating', function () {
//       expect(iD.osmWay({ tags: { oneway: 'alternating' } }).isOneWay(), 'oneway alternating').to.be
//         .true;
//     });
...
//       expect(iD.osmWay({ tags: { highway: 'motorway_link' } }).isOneWay(), 'motorway_link').to.be
//         .false;
...
//       expect(iD.osmWay({ tags: { highway: 'primary_link' } }).isOneWay(), 'primary_link').to.be
//         .false;
//       expect(iD.osmWay({ tags: { highway: 'secondary' } }).isOneWay(), 'secondary').to.be.false;
//       expect(iD.osmWay({ tags: { highway: 'secondary_link' } }).isOneWay(), 'secondary_link').to.be
//         .false;
//       expect(iD.osmWay({ tags: { highway: 'tertiary' } }).isOneWay(), 'tertiary').to.be.false;
//       expect(iD.osmWay({ tags: { highway: 'tertiary_link' } }).isOneWay(), 'tertiary_link').to.be
//         .false;
//       expect(iD.osmWay({ tags: { highway: 'unclassified' } }).isOneWay(), 'unclassified').to.be
//         .false;
//       expect(iD.osmWay({ tags: { highway: 'residential' } }).isOneWay(), 'residential').to.be.false;
//       expect(iD.osmWay({ tags: { highway: 'living_street' } }).isOneWay(), 'living_street').to.be
//         .false;
...
//       expect(iD.osmWay({ tags: { junction: 'roundabout', oneway: 'no' } }).isOneWay(), 'roundabout')
//         .to.be.false;
//       expect(iD.osmWay({ tags: { junction: 'circular', oneway: 'no' } }).isOneWay(), 'circular').to
//         .be.false;
//       expect(iD.osmWay({ tags: { highway: 'motorway', oneway: 'no' } }).isOneWay(), 'motorway').to
//         .be.false;
//     });
//   });
...
//       expect(iD.osmWay({ tags: { natural: 'coastline' } }).sidednessIdentifier()).to.eql(
//         'coastline'
//       );
//       expect(iD.osmWay({ tags: { barrier: 'retaining_wall' } }).sidednessIdentifier()).to.eql(
//         'barrier'
//       );
//       expect(iD.osmWay({ tags: { barrier: 'kerb' } }).sidednessIdentifier()).to.eql('barrier');
//       expect(iD.osmWay({ tags: { barrier: 'guard_rail' } }).sidednessIdentifier()).to.eql(
//         'barrier'
//       );
//       expect(iD.osmWay({ tags: { barrier: 'city_wall' } }).sidednessIdentifier()).to.eql('barrier');
//       expect(iD.osmWay({ tags: { man_made: 'embankment' } }).sidednessIdentifier()).to.eql(
//         'man_made'
//       );
//     });
...
//       expect(iD.osmWay({ tags: { barrier: 'retaining_wall', two_sided: 'yes' } }).isSided()).to.be
//         .false;
//       expect(iD.osmWay({ tags: { barrier: 'kerb', two_sided: 'yes' } }).isSided()).to.be.false;
//       expect(iD.osmWay({ tags: { barrier: 'guard_rail', two_sided: 'yes' } }).isSided()).to.be
//         .false;
//       expect(iD.osmWay({ tags: { barrier: 'city_wall', two_sided: 'yes' } }).isSided()).to.be.false;
//       expect(iD.osmWay({ tags: { man_made: 'embankment', two_sided: 'yes' } }).isSided()).to.be
//         .false;
//     });
...
//       expect(iD.osmWay({ tags: { barrier: 'retaining_wall', two_sided: 'no' } }).isSided()).to.be
//         .true;
...
//       expect(
//         iD.osmWay({ nodes: ['n1', 'n1'], tags: { highway: 'services' } }).isArea(),
//         'highway=services'
//       ).to.equal(true);
//       expect(
//         iD.osmWay({ nodes: ['n1', 'n1'], tags: { highway: 'rest_area' } }).isArea(),
//         'highway=rest_area'
//       ).to.equal(true);
//       expect(
//         iD.osmWay({ nodes: ['n1', 'n1'], tags: { railway: 'roundhouse' } }).isArea(),
//         'railway=roundhouse'
//       ).to.equal(true);
//       expect(
//         iD.osmWay({ nodes: ['n1', 'n1'], tags: { railway: 'station' } }).isArea(),
//         'railway=station'
//       ).to.equal(true);
//       expect(
//         iD.osmWay({ nodes: ['n1', 'n1'], tags: { railway: 'traverser' } }).isArea(),
//         'railway=traverser'
//       ).to.equal(true);
//       expect(
//         iD.osmWay({ nodes: ['n1', 'n1'], tags: { railway: 'turntable' } }).isArea(),
//         'railway=turntable'
//       ).to.equal(true);
//       expect(
//         iD.osmWay({ nodes: ['n1', 'n1'], tags: { railway: 'wash' } }).isArea(),
//         'railway=wash'
//       ).to.equal(true);
//     });
...
//       expect(
//         iD.osmWay({ nodes: ['n1', 'n1'], tags: { area: 'no', building: 'yes' } }).isArea()
//       ).to.equal(false);
//     });

//     it('returns false for coastline', function () {
//       expect(iD.osmWay({ nodes: ['n1', 'n1'], tags: { natural: 'coastline' } }).isArea()).to.equal(
//         false
//       );
//     });
//   });
...
//       expect(iD.osmWay({ tags: { area: 'yes' }, nodes: ['a', 'b', 'a'] }).isDegenerate()).to.equal(
//         true
//       );
//     });
...
//       expect(
//         iD.osmWay({ tags: { area: 'yes' }, nodes: ['a', 'b', 'c', 'a'] }).isDegenerate()
//       ).to.equal(false);
//     });
//   });
...
//         'abca',
//         'duplicate connector node at beginning'
//       );
//       var w4 = iD.osmWay({ nodes: 'abcaa'.split('') });
...
//         'aa',
//         'single node circular with duplicates'
//       );
//     });
...
//         'dabcd',
//         'duplicate internal node in middle'
//       );
//       var w3 = iD.osmWay({ nodes: 'aabca'.split('') });
...
//     it('throws RangeError if index outside of array range for linear way', function () {
//       var w = iD.osmWay({ nodes: 'ab'.split('') });
//       expect(w.updateNode.bind(w, 'd', 2)).to.throw(
//         RangeError,
//         /out of range 0\.\.1/,
//         'over range'
//       );
//       expect(w.updateNode.bind(w, 'd', -1)).to.throw(
//         RangeError,
//         /out of range 0\.\.1/,
//         'under range'
//       );
...
//     it('throws RangeError if index outside of array range for circular way', function () {
//       var w = iD.osmWay({ nodes: 'aba'.split('') });
//       expect(w.updateNode.bind(w, 'd', 3)).to.throw(
//         RangeError,
//         /out of range 0\.\.2/,
//         'over range'
//       );
...
//         'abca',
//         'duplicate connector node at end'
//       );
//       var w5 = iD.osmWay({ nodes: 'abbbcbba'.split('') });
...
//         'abcda',
//         'duplicate internal node at end'
//       );
//       var w2 = iD.osmWay({ nodes: 'abbca'.split('') });
...
//         'dd',
//         'multiple replace, single node circular'
//       );
//     });
...
//         'dbcd',
//         'duplicate beginning connector'
//       );
//       var w3 = iD.osmWay({ nodes: 'aabcaa'.split('') });
//       expect(w3.replaceNode('a', 'd').nodes.join('')).to.eql(
//         'dbcd',
//         'duplicate beginning and end connectors'
//       );
