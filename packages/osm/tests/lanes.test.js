...
//         expect(
//           iD.osmWay({ tags: { highway: 'motorway' } }).lanes().metadata.count,
//           'motorway lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'motorway', oneway: 'yes' } }).lanes().metadata.count,
//           'motorway lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'motorway', oneway: 'no' } }).lanes().metadata.count,
//           'motorway lanes'
//         ).to.eql(4);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'motorway_link' } }).lanes().metadata.count,
//           'motorway_link lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'motorway_link', oneway: 'no' } }).lanes().metadata.count,
//           'motorway_link lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'motorway_link', oneway: 'yes' } }).lanes().metadata.count,
//           'motorway_link lanes'
//         ).to.eql(1);
//       });
//     });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'trunk' } }).lanes().metadata.count,
//           'trunk lanes'
//         ).to.eql(4);
//         expect(
//           iD.osmWay({ tags: { highway: 'trunk', oneway: 'no' } }).lanes().metadata.count,
//           'trunk lanes'
//         ).to.eql(4);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'trunk', oneway: 'yes' } }).lanes().metadata.count,
//           'trunk lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'trunk_link' } }).lanes().metadata.count,
//           'trunk_link lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'trunk_link', oneway: 'no' } }).lanes().metadata.count,
//           'trunk_link lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'trunk_link', oneway: 'yes' } }).lanes().metadata.count,
//           'trunk_link lanes'
//         ).to.eql(1);
//       });
//     });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'primary' } }).lanes().metadata.count,
//           'primary lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'primary', oneway: 'no' } }).lanes().metadata.count,
//           'primary lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'primary', oneway: 'yes' } }).lanes().metadata.count,
//           'primary lanes'
//         ).to.eql(1);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'primary_link' } }).lanes().metadata.count,
//           'primary lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'primary_link', oneway: 'no' } }).lanes().metadata.count,
//           'primary lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'primary_link', oneway: 'yes' } }).lanes().metadata.count,
//           'primary lanes'
//         ).to.eql(1);
//       });
//     });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'secondary' } }).lanes().metadata.count,
//           'secondary lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'secondary', oneway: 'no' } }).lanes().metadata.count,
//           'secondary lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'secondary', oneway: 'yes' } }).lanes().metadata.count,
//           'secondary lanes'
//         ).to.eql(1);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'secondary_link' } }).lanes().metadata.count,
//           'secondary_link lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'secondary_link', oneway: 'no' } }).lanes().metadata.count,
//           'secondary_link lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'secondary_link', oneway: 'yes' } }).lanes().metadata.count,
//           'secondary_link lanes'
//         ).to.eql(1);
//       });
//     });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'tertiary' } }).lanes().metadata.count,
//           'tertiary lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'tertiary', oneway: 'no' } }).lanes().metadata.count,
//           'tertiary lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'tertiary', oneway: 'yes' } }).lanes().metadata.count,
//           'tertiary lanes'
//         ).to.eql(1);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'tertiary_link' } }).lanes().metadata.count,
//           'tertiary_link lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'tertiary_link', oneway: 'no' } }).lanes().metadata.count,
//           'tertiary_link lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'tertiary_link', oneway: 'yes' } }).lanes().metadata.count,
//           'tertiary_link lanes'
//         ).to.eql(1);
//       });
//     });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'residential' } }).lanes().metadata.count,
//           'residential lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'residential', oneway: 'no' } }).lanes().metadata.count,
//           'residential lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'residential', oneway: 'yes' } }).lanes().metadata.count,
//           'residential lanes'
//         ).to.eql(1);
//       });
//     });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'service' } }).lanes().metadata.count,
//           'service lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'service', oneway: 'no' } }).lanes().metadata.count,
//           'service lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'service', oneway: 'yes' } }).lanes().metadata.count,
//           'service lanes'
//         ).to.eql(1);
//       });
//     });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'track' } }).lanes().metadata.count,
//           'track lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'track', oneway: 'no' } }).lanes().metadata.count,
//           'track lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'track', oneway: 'yes' } }).lanes().metadata.count,
//           'track lanes'
//         ).to.eql(1);
//       });
//     });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'path' } }).lanes().metadata.count,
//           'path lanes'
//         ).to.eql(2);
//         expect(
//           iD.osmWay({ tags: { highway: 'path', oneway: 'no' } }).lanes().metadata.count,
//           'path lanes'
//         ).to.eql(2);
//       });
...
//         expect(
//           iD.osmWay({ tags: { highway: 'path', oneway: 'yes' } }).lanes().metadata.count,
//           'path lanes'
//         ).to.eql(1);
//       });
//     });
...
//       expect(
//         iD.osmWay({ tags: { highway: 'residential', oneway: 'yes' } }).lanes().metadata.oneway,
//         'residential lanes'
//       ).to.be.true;
//       expect(
//         iD.osmWay({ tags: { highway: 'residential', oneway: 'no' } }).lanes().metadata.oneway,
//         'residential lanes'
//       ).to.be.false;
//     });
//   });
...
//         iD
//           .osmWay({
//             tags: { highway: 'residential', lanes: 2, 'lanes:forward': 1, 'lanes:backward': 1 }
//           })
//           .lanes().metadata,
//         'residential lanes'
//       ).to.include({
...
//         iD
//           .osmWay({
//             tags: { highway: 'residential', lanes: 4, 'lanes:forward': 3, 'lanes:backward': 1 }
//           })
//           .lanes().metadata,
//         'residential lanes'
//       ).to.include({
...
//       expect(
//         iD.osmWay({ tags: { highway: 'trunk', lanes: 2, 'lanes:forward': 3 } }).lanes().metadata,
//         'trunk lanes'
//       ).to.include({
//         count: 2,
//         oneway: false,
...
//       expect(
//         iD.osmWay({ tags: { highway: 'trunk', lanes: 2, oneway: 'yes' } }).lanes().metadata,
//         'trunk lanes'
//       ).to.include({
//         count: 2,
//         oneway: true,
...
//       expect(
//         iD.osmWay({ tags: { highway: 'primary', lanes: 4, oneway: '-1' } }).lanes().metadata,
//         'primary lanes'
//       ).to.include({
//         count: 4,
//         oneway: true,
...
//       expect(
//         iD
//           .osmWay({ tags: { highway: 'trunk', lanes: 2, oneway: 'yes', 'lanes:forward': 1 } })
//           .lanes().metadata,
//         'trunk lanes'
//       ).to.include({
//         count: 2,
...
//       expect(
//         iD
//           .osmWay({ tags: { highway: 'trunk', lanes: 2, oneway: 'yes', 'lanes:backward': 1 } })
//           .lanes().metadata,
//         'trunk lanes'
//       ).to.include({
//         count: 2,
...
//       expect(
//         iD.osmWay({ tags: { highway: 'residential', lanes: 3, 'lanes:backward': 1 } }).lanes()
//           .metadata,
//         'residential lanes'
//       ).to.include({
//         count: 3,
...
//       });
//       expect(
//         iD.osmWay({ tags: { highway: 'residential', lanes: 4, 'lanes:backward': 3 } }).lanes()
//           .metadata,
//         'residential lanes'
//       ).to.include({
//         count: 4,
...
//       expect(
//         iD.osmWay({ tags: { highway: 'residential', lanes: 3, 'lanes:forward': 1 } }).lanes()
//           .metadata,
//         'residential lanes'
//       ).to.include({
//         count: 3,
...
//       });
//       expect(
//         iD.osmWay({ tags: { highway: 'residential', lanes: 2, 'lanes:forward': 1 } }).lanes()
//           .metadata,
//         'residential lanes'
//       ).to.include({
//         count: 2,
...
//         iD
//           .osmWay({
//             tags: { highway: 'residential', lanes: 3, 'lanes:forward': 1, 'lanes:both_ways': 1 }
//           })
//           .lanes().metadata,
//         'residential lanes'
//       ).to.include({
...
//         iD
//           .osmWay({
//             tags: { highway: 'residential', lanes: 5, 'lanes:forward': 1, 'lanes:both_ways': 1 }
//           })
//           .lanes().metadata,
//         'residential lanes'
//       ).to.include({
...
//         iD
//           .osmWay({
//             tags: { highway: 'residential', lanes: 3, 'lanes:backward': 1, 'lanes:both_ways': 1 }
//           })
//           .lanes().metadata,
//         'residential lanes'
//       ).to.include({
...
//         iD
//           .osmWay({
//             tags: { highway: 'residential', lanes: 5, 'lanes:backward': 1, 'lanes:both_ways': 1 }
//           })
//           .lanes().metadata,
//         'residential lanes'
//       ).to.include({
...
//         iD
//           .osmWay({
//             tags: { highway: 'residential', lanes: 2, 'lanes:forward': 1, 'lanes:both_ways': 1 }
//           })
//           .lanes().metadata,
//         'residential lanes'
//       ).to.include({
...
//         })
//         .lanes().metadata;
//       expect(metadata.turnLanes.unspecified).to.deep.equal([['none'], ['slight_right']]);
//     });
...
//         })
//         .lanes().metadata;
//       expect(metadata.turnLanes.forward).to.deep.equal([['slight_left']]);
//       expect(metadata.turnLanes.backward).to.deep.equal([
//         ['none'],
//         ['through'],
...
//             oneway: 'yes',
//             'turn:lanes':
//               'slight_left;reverse;left|slight_left;left;through|through|none|through;right'
//           }
//         })
//         .lanes();

//       expect(lanesData.metadata.turnLanes.unspecified).to.deep.equal([
...
//         })
//         .lanes();
//       expect(lanesData.metadata.turnLanes.forward).to.deep.equal([
//         ['slight_left', 'reverse', 'left'],
//         ['slight_left', 'left', 'through'],
//         ['through']
//       ]);
//       expect(lanesData.metadata.turnLanes.backward).to.deep.equal([['none'], ['through', 'left']]);
//     });
...
//         })
//         .lanes().metadata;
//       expect(metadata.turnLanes.forward).to.deep.equal([['unknown']]);
//       expect(metadata.turnLanes.backward).to.deep.equal([
//         ['none'],
//         ['through'],
...
//       expect(metadata.turnLanes.unspecified).to.deep.equal([['slight_left'], ['none']]);
//     });
...
//       expect(metadata.turnLanes.forward).to.deep.equal([['slight_left'], ['unknown'], ['unknown']]);
//       expect(metadata.turnLanes.backward).to.deep.equal([['through'], ['unknown']]);
//     });
...
//       expect(metadata.turnLanes).to.deep.equal([['through'], ['through', 'slight_right']]);
//     });
...
//       expect(metadata.turnLanes.unspecified).to.equal(undefined);
//       expect(metadata.turnLanes.forward).to.equal(undefined);
//       expect(metadata.turnLanes.backward).to.equal(undefined);
//     });
...
//         })
//         .lanes();
//       expect(lanes.metadata.turnLanes.backward).to.deep.equal([['slight_right']]);
//       expect(lanes.metadata.turnLanes.forward).to.deep.equal([['slight_left'], ['none'], ['none']]);
//     });
...
//         })
//         .lanes();
//       expect(lanes.metadata.turnLanes.forward).to.deep.equal([['through']]);
//       expect(lanes.metadata.turnLanes.backward).to.deep.equal([
//         ['slight_left'],
//         ['none'],
//         ['none']
//       ]);
...
//       expect(metadata.turnLanes.unspecified).to.deep.equal([['none'], ['through'], ['none']]);
//     });
...
//         ['through', 'slight_right']
//       ]);
//       expect(metadata.turnLanes.backward).to.deep.equal([['none']]);
//     });
...
//       expect(metadata.turnLanes.forward).to.deep.equal([['slight_left'], ['none'], ['none']]);
//       expect(metadata.turnLanes.backward).to.deep.equal([['none'], ['none']]);
//     });
...
//         })
//         .lanes().lanes;
//       var turnLanesUnspecified = lanes.unspecified.map(function (l) {
//         return l.turnLane;
//       });
...
//       var turnLanesForward = lanes.forward.map(function (l) {
//         return l.turnLane;
//       });
//       var turnLanesBackward = lanes.backward.map(function (l) {
//         return l.turnLane;
//       });
//       expect(turnLanesForward).to.deep.equal([['slight_left'], ['none'], ['none']]);
//       expect(turnLanesBackward).to.deep.equal([['none'], ['slight_right']]);
//     });
//   });
...
//       expect(maxspeedLanes).to.deep.equal([30, 40, 40, 40, 40]);
//     });
...
//         })
//         .lanes().metadata;
//       expect(metadata.maxspeedLanes.forward).to.deep.equal([null, 40, 40, 40]);
//       expect(metadata.maxspeedLanes.backward).to.deep.equal([null]);
//     });
...
//       expect(maxspeedLanes.unspecified).to.deep.equal([30, null, null, null]);
//     });
...
//         })
//         .lanes();
//       expect(lanes.metadata.maxspeedLanes.unspecified).to.deep.equal([30, null, null, null]);
//     });
...
//         })
//         .lanes().metadata.maxspeedLanes;
//       expect(maxspeedLanes.unspecified).to.deep.equal([30, null, null, null, null]);
//       maxspeedLanes = iD
//         .osmWay({
//           tags: {
//             highway: 'residential',
...
//         })
//         .lanes().metadata.maxspeedLanes;
//       expect(maxspeedLanes.unspecified).to.deep.equal([30, 40, 40, 40, 40]);
//       maxspeedLanes = iD
//         .osmWay({
//           tags: {
//             highway: 'residential',
...
//         })
//         .lanes().metadata.maxspeedLanes;
//       expect(maxspeedLanes.unspecified).to.deep.equal([null, 40, 40, 40, 40]);
//     });
...
//         })
//         .lanes().metadata.maxspeedLanes;
//       expect(maxspeedLanes.unspecified).to.deep.equal([null, 40, 'unknown', 40, 40]);
//       maxspeedLanes = iD
//         .osmWay({
//           tags: {
//             highway: 'residential',
...
//       expect(maxspeedLanes.unspecified).to.deep.equal([null, 40, 'unknown', 40, 'unknown']);
//     });
...
//         })
//         .lanes().metadata.maxspeedLanes;
//       expect(maxspeedLanes.unspecified).to.deep.equal([30, 40, 'none', 40, 40]);
//     });
...
//         return l.maxspeed;
//       });
//       expect(maxspeedLanes).to.deep.equal([null, 40, 'unknown', 40, 40]);
//     });
//   });
...
//         return l.bicycleway;
//       });
//       expect(bicyclewayLanes).to.deep.equal(['no', 'yes', 'no', 'designated', 'no']);
//     });
...
//         'no'
//       ]);
//       expect(lanes.metadata.bicyclewayLanes.backward).to.deep.equal(['lane', 'no', 'no', 'no']);
//       var bicyclewayLanesForward = lanes.lanes.forward.map(function (l) {
//         return l.bicycleway;
//       });
//       expect(bicyclewayLanesForward).to.deep.equal(['lane', 'no', 'no', 'no', 'no']);
//       var bicyclewayLanesBackward = lanes.lanes.backward.map(function (l) {
//         return l.bicycleway;
//       });
//       expect(bicyclewayLanesBackward).to.deep.equal(['lane', 'no', 'no', 'no']);
//     });
...
//         return l.bicycleway;
//       });
//       expect(psvLanesForward).to.deep.equal(['no', 'unknown', 'no', 'designated', 'no']);
//     });
//   });
...
//         })
//         .lanes();
//       expect(lanes.metadata.psvLanes.unspecified).to.deep.equal(['yes', 'no', 'no', 'no', 'no']);
//       var psvLanesForward = lanes.lanes.unspecified.map(function (l) {
//         return l.psv;
//       });
//       expect(psvLanesForward).to.deep.equal(['yes', 'no', 'no', 'no', 'no']);
//     });
...
//         })
//         .lanes();
//       expect(lanes.metadata.psvLanes.forward).to.deep.equal(['no', 'no', 'no']);
//       expect(lanes.metadata.psvLanes.backward).to.deep.equal(['yes', 'designated']);
...
//         return l.psv;
//       });
//       expect(psvLanesForward).to.deep.equal(['no', 'no', 'no']);
//       expect(psvLanesBackward).to.deep.equal(['yes', 'designated']);
//     });
//     it('should replace any invalid value with unknown', function () {
//       var lanes = iD
//         .osmWay({
...
//         })
//         .lanes();
//       expect(lanes.metadata.psvLanes.unspecified).to.deep.equal(['yes', 'no', 'unknown']);
//       var psvLanesForward = lanes.lanes.unspecified.map(function (l) {
//         return l.psv;
//       });
//       expect(psvLanesForward).to.deep.equal(['yes', 'no', 'unknown']);
//     });
//   });
// });
